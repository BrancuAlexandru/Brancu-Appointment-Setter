<form action="{{ route('managementMakeAppointment') }}" method="post" style="max-width: 70%; margin-top: 2px; margin-left: auto; margin-right: auto;">
  ...
  <div class="container text-center d-flex flex-row align-items-start justify-content-center" style="width: 80%; margin: 0 auto;">
    <div id="column1" class="d-flex flex-column align-items-center justify-content-center" style="background-color: #efefef; max-width: max-content;">
      ...
      <p style="margin-bottom: 0; padding: 10px 20px; border-right: 2px solid white; width: 100%;">aaaaaaaaaaaaaaaaaexample1@gmail.com</p>
      <p style="margin-bottom: 0; padding: 10px 20px; border-right: 2px solid white; width: 100%;">example2@gmail.com</p>
      <p style="margin-bottom: 0; padding: 10px 20px; border-right: 2px solid white; width: 100%;">example3@gmail.com</p>
    </div>
    <div id="column2" class="d-flex flex-column align-items-center justify-content-center" style="background-color: #efefef; max-width: max-content;">
      ...
      <p style="margin-bottom: 0; padding: 10px 20px; border-right: 2px solid white; width: 100%;">July</p>
      <p style="margin-bottom: 0; padding: 10px 20px; border-right: 2px solid white; width: 100%;">July</p>
      <p style="margin-bottom: 0; padding: 10px 20px; border-right: 2px solid white; width: 100%;">August</p>
    </div>
    <div id="column2" class="d-flex flex-column align-items-center justify-content-center" style="background-color: #efefef; max-width: max-content;">
      <p style="margin-bottom: 0; padding: 10px 20px; border-right: 2px solid white; width: 100%;">Day</p>
      <p style="margin-bottom: 0; padding: 10px 20px; border-right: 2px solid white; width: 100%;">25</p>
      <p style="margin-bottom: 0; padding: 10px 20px; border-right: 2px solid white; width: 100%;">25</p>
      <p style="margin-bottom: 0; padding: 10px 20px; border-right: 2px solid white; width: 100%;">1</p>
    </div>
    <div id="column3" class="d-flex flex-column align-items-center justify-content-center" style="background-color: #efefef; max-width: max-content;">
      ...
      <p style="margin-bottom: 0; padding: 10px 20px; border-right: 2px solid white; width: 100%;">9:00-10:00</p>
      <p style="margin-bottom: 0; padding: 10px 20px; border-right: 2px solid white; width: 100%;">10:30-11:30</p>
      <p style="margin-bottom: 0; padding: 10px 20px; border-right: 2px solid white; width: 100%;">15:30-16:30</p>
    </div>
